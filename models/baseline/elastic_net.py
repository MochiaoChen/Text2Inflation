"""Elastic Net baseline — expanding-window."""
import os
...
def run_elastic_net_baseline(file_path=None):
    setup_plot_style()
    ...
    metrics = evaluate_and_plot(y_true, y_pred, 'Elastic Net (Baseline)',
                                os.path.join(BASELINE_OUTPUT_DIR, '3_elastic_net.png'))
