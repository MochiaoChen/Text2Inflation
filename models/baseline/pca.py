"""PCA + OLS baseline — expanding-window。PCA 保留解释 95% 方差的成分。"""
import os
...
def run_pca_baseline(file_path=None):
    setup_plot_style()
    ...
    metrics = evaluate_and_plot(y_true, y_pred, 'PCA + OLS (Baseline)',
                                os.path.join(BASELINE_OUTPUT_DIR, '4_pca.png'))
