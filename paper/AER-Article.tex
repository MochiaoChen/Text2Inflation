...
\title{When Does Central-Bank Narrative Help? \\
  Evidence from LLM Extraction of People's Bank of China \\
  Monetary Policy Reports}
\shortTitle{Text-to-Inflation}
\author{Mochiao Chen\thanks{Chen: China School of Banking and Finance,
University of International Business and Economics, Beijing, China
(\href{mailto:mochiao.chen@gmail.com}{mochiao.chen@gmail.com}).
...
\end{tabular}
\begin{tablenotes}
$^{*}$ significant at 10 percent (one-sided), $^{**}$ significant at 5 percent. Positive DM statistic means baseline's
...
\midrule
Full sample            & 56 & 0.517 & 0.500 & $+3.4\%$ \\
\addlinespace
